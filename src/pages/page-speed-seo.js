...
export async function getServerData() {
  const rest = await fetch(
    "https://api.aglty.io/800c8044/fetch/en-us/page/117?contentLinkDepth=3&expandAllContentLinks=true",
    {
      headers: {
        APIKEY:
